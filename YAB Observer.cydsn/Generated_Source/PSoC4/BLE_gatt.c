    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'Y', (uint8)'A', (uint8)'B', (uint8)'_', (uint8)'O', (uint8)'B', (uint8)'S', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[13] }, /* Custom Characteristic */
    { 0x0001u, (void *)&cyBle_attValues[14] }, /* Custom Descriptor */
};
